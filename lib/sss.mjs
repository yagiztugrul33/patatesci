...
export const SSS = [
  ...
  { q: "Sipariş verdikten sonra piyasa değişirse fiyat değişir mi?", a: "Hayır. Fiyat eşleşme anında KİLİTLENİR; piyasa çökse de uçsa da geçerlidir. Cayan taraf aşamasına göre iptal cezası öder (%1-%5)." },
