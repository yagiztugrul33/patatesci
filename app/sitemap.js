...
export default function sitemap() {
  ...
  const sayfalar = [
    ...
    { yol: "/hukuki/acik-riza", oncelik: 0.3, siklik: "monthly" },
    { yol: "/hukuki/cerez-politikasi", oncelik: 0.3, siklik: "monthly" },
    { yol: "/hukuki/kullanici-sozlesmesi", oncelik: 0.3, siklik: "monthly" },
    { yol: "/hukuki/uretici-sozlesmesi", oncelik: 0.3, siklik: "monthly" },
    { yol: "/hukuki/alici-sozlesmesi", oncelik: 0.3, siklik: "monthly" },
